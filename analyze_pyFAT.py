...
def main():
    ...
    sf.analyze(Database_Directory,Database_config_file, basename=f'GDL_{version}_Results')
    sf.analyze(LVHIS_Directory,LVHIS_config_file, basename=f'GDL_{version}_Results',LVHIS=True)
