...
;for i=21,24 do begin
 ...
 print,'this is the galaxy we are going to look at'
   ...
   IF FILE_TEST(main_dir+'/'+HPASSname[i]+'/Finalmodel/Finalmodel.def') then begin
      ...
      IF FILE_TEST(main_dir+'/'+HPASSname[i]+'/Fit_Tirific_OSC/Finalmodel_unsmoothed.def') then begin
...
;print,G2
 ...
 ;  print,first, HPASSNamein1[i]
   ;IF first eq 1 OR HPASSNamein2[i] EQ '-1' then radii=TirResult[*,0] else
   radii=Tirresult2[*,0]
