Pro Interpolate,Values,radii,output=output,newradii=newradii
  ...
  IF  n_elements(radii) LT 2 OR n_elements(radii) NE n_elements(Values) then begin
     ...
     print, n_elements(radii),n_elements(Values)
     stop
     goto,breakthis
  ENDIF
...
;  print,newradii,radii
;  print,newparameter
;  set_plot,'X',/copy
;  plot,Radii,Values,XSTYLE=1,xrange=[minx,maxx],yrange=[miny,maxy]
;  oplot,Newradii,newparameter,linestyle=2
  case halved of
     0:begin
